...
// print_r(Quicksort::sort([4,3,8,2,9]));

print_r(UsefulFunction::rotate_to_right([1,2,3,4,5,6], 2));
print_r(UsefulFunction::sort_even_crescent_odd_decrescent([6,5,4,3,2,1]));
...
print_r(UsefulFunction::combine2([1,2,3,4,5,6]));
print_r(UsefulFunction::combine([1,2,3,4,5,6], 3));
print_r(UsefulFunction::get_triangles([1,2,3,4]));
print_r(UsefulFunction::get_triangles([1,2,3,4,5,6]));
print_r(UsefulFunction::contains("amarelo", "amak"));
print_r(UsefulFunction::contains("amarelo", "amar"));
print_r(UsefulFunction::contains("amarelo", "amaro"));
print_r(UsefulFunction::contains("amarelo", "o"));
print_r(UsefulFunction::contains("amarelo", "b"));
