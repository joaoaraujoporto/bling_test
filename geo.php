...
class Rectangle {
    ...
    public function __construct($bottom_left_point, $top_right_point) {
    ...
    public static function validate_points_as_rectangle($bottom_left_point, $top_right_point) {
    ...
    public function get_overlap_rectangle($rectangle) {
        $overlap_rect_top_right_point_x = get_min_value([$this->top_right_point->x, $rectangle->top_right_point->x]);
        $overlap_rect_top_right_point_y = get_min_value([$this->top_right_point->y, $rectangle->top_right_point->y]);
        
        $overlap_rect_bottom_left_point_x = get_max_value([$this->bottom_left_point->x, $rectangle->bottom_left_point->x]);
        $overlap_rect_bottom_left_point_y = get_max_value([$this->bottom_left_point->y, $rectangle->bottom_left_point->y]);
    ...
    public function get_overlap_area($rectangle) {
        $overlap_rectangle = $this->get_overlap_rectangle($rectangle);
