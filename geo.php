...
class Rectangle {
    ...
    public function get_overlap_rectangle($another_rectangle) {
        $overlap_rect_top_right_point_x = get_min_value([$this->top_right_point->x, $another_rectangle->top_right_point->x]);
        $overlap_rect_top_right_point_y = get_min_value([$this->top_right_point->y, $another_rectangle->top_right_point->y]);
        
        $overlap_rect_bottom_left_point_x = get_max_value([$this->bottom_left_point->x, $another_rectangle->bottom_left_point->x]);
        $overlap_rect_bottom_left_point_y = get_max_value([$this->bottom_left_point->y, $another_rectangle->bottom_left_point->y]);
